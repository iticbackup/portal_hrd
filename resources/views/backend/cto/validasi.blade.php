                            ...
                            <div class="card-body pt-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="mb-3">Data Terakhir Kendaraan (KM)</div>
                                                <table class="table table-bordered">
                                                    <tr>
                                                        <td class="text-center">KM Terakhir</td>
                                                        <td class="text-center">No. Polisi</td>
                                                        <td class="text-center">Tanggal Terakhir</td>
                                                    </tr>
                                                    @foreach ($km_cars as $km_car)
                                                        <tr>
                                                            <td class="text-center">{{ $km_car->security_km_masuk }}</td>
                                                            <td class="text-center">{{ explode('-', $km_car->no_polisi)[0] .' '. explode('-', $km_car->no_polisi)[1] .' '. explode('-', $km_car->no_polisi)[2] }}</td>
                                                            <td class="text-center">{{ $km_car->created_at->format('d-m-Y H:i:s') }}</td>
                                                        </tr>
                                                    @endforeach
                                                </table>
                                            </div>
